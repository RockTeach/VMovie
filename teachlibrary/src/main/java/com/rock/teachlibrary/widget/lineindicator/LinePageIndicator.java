package com.rock.teachlibrary.widget.lineindicator;
...
import com.rock.teachlibrary.R;
...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int count = mViewPager.getAdapter().getCount() / pageMultiple;
        if (count == 0) {
            return;
        }
        ...
        for (int i = 0; i < count; i++) {
            ...
            canvas.drawLine(dx1, verticalOffset, dx2, verticalOffset, (i == mCurrentPage % count) ? mPaintSelected : mPaintUnselected);
        }
    }
    ...
    public void setViewPager(int pageMultiple ,ViewPager viewpager){
        this.pageMultiple = pageMultiple;
    ...
    private int measureWidth(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (mViewPager == null)) {
            ...
            // TODO Calculate the width according the views count
            final int count = mViewPager.getAdapter().getCount() / pageMultiple;
